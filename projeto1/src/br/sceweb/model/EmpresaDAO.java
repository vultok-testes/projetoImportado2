...
/**
 * Esta classe registra as informações de empressas que podem oferecer estágio para alunos
 * @author Elton 
 * @version 1.0
 *
 */
public class EmpresaDAO {
	...
	/**
	 * Método adiciona empresas 
	 * @param empresa
	 * @return Um int informando o status da operação
	 */
